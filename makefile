...
hw2: main.o Shapes.o Sort.o Atom.o Variable.o Number.o
ifeq (${OS}, Windows_NT)
	g++ -o hw2 main.o Shapes.o Sort.o Atom.o Variable.o Number.o -lgtest
else
	g++ -o hw2 main.o Shapes.o Sort.o Atom.o Variable.o Number.o -lgtest -lpthread
endif
